...
<nav class="menu">
  ...
  <table class="login_tbl">
	...
	<div >
		<form action="" method="POST" >
            <p style="font-size: 2rem; font-weight: 800;">Edit Product</p>
			<div >
            ...
            <div>
				<button name="submit" class="receipt_btn", id="submit">Edit Product</button>
			</div> <br><br><br>
		...
		<?php
            ...
            if (isset($_POST['submit'])) {
              edit_product('productID', 'productName', 'listPrice');
            return;
          }
          ?>
